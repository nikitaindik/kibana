...
export const FILTERS_VALUE_ITEM = '[data-test-subj^="filtersPropertyValue"]';
...
export const SAVED_QUERY_FILTERS_VALUE = '[data-test-subj^="savedQueryFiltersPropertyValue"]';
...
export const THREAT_FILTERS_VALUE_ITEM = '[data-test-subj^="threatFiltersPropertyValue"]';
